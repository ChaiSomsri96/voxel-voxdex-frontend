  ...
  return (
    <ModalCenter isOpen={show}>
      <Container>
        ...
        <TextWrapper>
          <Trans>
            VoxelSwap strives to offer its users the best DeFi experience on a single platform. In order to do that,
            VoxelSwap partners with 3rd party platforms like Multichain.
          </Trans>
        </TextWrapper>
        <TextWrapper>
          <Trans>
            ...
            our partners platform, VoxelSwap won&apos;t assume any liability for any losses incurred.
          </Trans>
        </TextWrapper>
